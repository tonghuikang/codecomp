...
#define SCAN_ARR(arr, k) REP(i, 1, n+1) scanf("%lld", &arr[i]);
// scan matrix (tbc)
// scan string
...
// reminders
// If the intended result is LL, make sure the first element in the operation is LL
// e.g. instead of `1 << j`, do `1LL << j`
