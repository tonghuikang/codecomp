...
def solve_(n,m,h,mrr):
    # your solution here

    # for each number of monsters, what is the minimum number of amulets you need
    # to defeat n+1th monster, you need at most 1 additional amulet
    ...
    r2 = []
    for i in range(m+1):
        r2.append(bisect.bisect_right(res, i))
...
# for case_num in range(int(input())):
    ...
    res = solve(n,m,h,mrr)  # include input here
