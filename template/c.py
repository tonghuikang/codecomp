...
def solve_(n, arr):
    ...
    # if LCM not in arr, take everything
    ...
    # the lcm will be a factor of the largest number    
    factors = get_all_divisors_given_prime_factorization(get_prime_factors_with_precomp_sqrt(maxarr))
