...
def parse_url(url, retries=RETRY_COUNT):
    ...
    for problem in soup.find_all(class_="problem-statement"):
        ...
        print("Found problem {} with {} sample cases".format(question_number, min(len(inputs), len(outputs))))
...
if __name__ == "__main__":
    ...
    parser.add_argument("contest_id", type=int, help="The Codeforces contest ID is found in the url")
    parser.add_argument(
        "retry",
        default=False,
        action="store_true",
