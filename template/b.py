...
@cache
def f(x):
    return get_all_divisors_given_prime_factorization(get_prime_factors_with_precomp_sqrt(x))
...
for case_num in range(int(input())):
    ...
    res = solve(x, n)  # include input here
